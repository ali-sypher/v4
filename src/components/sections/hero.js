...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Ali Aliyyan.</h2>;
  const three = <h3 className="big-heading">I build AI Apps and Digital products.</h3>;
  const four = (
    <>
      <p>
  ...
  const five = (
    <a
      ...
      href="https://www.upwork.com/freelancers/~018d0e95e0592abed3"
      target="_blank"
      rel="noreferrer">
